  ...
  from (
    ...
    where (p_before is null or ae.created_at < p_before)
      and (
        ...
        or (ae.entity_type = 'customer' and ae.entity_id = any(customer_ids))
        or (ae.entity_type = 'corporate_account' and ae.entity_id = any(company_ids))
        ...
        or (ae.metadata->>'corporate_account_id') = any(company_ids::text[])
      )
