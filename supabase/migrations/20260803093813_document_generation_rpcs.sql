...
begin
  ...
  where (
      id = v_quote.booking_id
      or (v_quote.booking_id is null and enquiry_id = v_quote.enquiry_id)
    )
    and archived_at is null
  order by case when id = v_quote.booking_id then 0 else 1 end, created_at
  limit 1;
