...
begin
  ...
  values(p_quote_id,v_user,p_decision,v_quote.quote_version,v_snapshot,encode(extensions.digest(convert_to(v_snapshot::text,'UTF8'),'sha256'),'hex'),p_terms_confirmed) returning id into v_evidence;
