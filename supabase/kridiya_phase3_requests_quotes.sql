-- Kridiya Travel - document/info requests and priced quotes (phase 3)
-- Adds public.enquiry_requests (staff asks a text or file question, customer
-- responds), public.quotes (staff sets a price, customer accepts/declines),
-- and a private Storage bucket for the file responses.
...
-- Customers may only flip a quote from 'sent' to 'accepted'/'declined' - every
-- other field (price, terms, validity...) is locked once staff sends it.
...
-- ---------- Storage bucket for document-request file responses ----------
